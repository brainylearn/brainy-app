...
use brainy_domain::ai_integration::entities::chat::Chat;
...
use crate::common::app_data_directory::AppDataDirectory;
use brainy_domain::Guid;
use brainy_domain::ai_integration::entities::document::Document;
use brainy_domain::ai_integration::entities::message::{
    self, Message, MessageContent, ToolCallStatus,
};
